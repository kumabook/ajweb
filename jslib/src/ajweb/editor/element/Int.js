...
dojo.provide("ajweb.editor.element.Int");
dojo.declare("ajweb.editor.element.Int",
	     [ajweb.editor.element.Element],
  /** @lends ajweb.editor.element.Int.prototype */
  {
    /**
     * Constructor
    ...
    createDom: function(properties){
      var that = this;
      this.widget = new dijit.form.NumberSpinner(
	  {style: {position: "absolute", width: "200px", top: "5px"},
	   constraints: {min: -9999, max: 9999},
