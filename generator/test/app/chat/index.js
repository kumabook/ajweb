...
//    chat_room.add(message_label);
    ...
    var message = new ajweb.widget.textbox({"content":"message","id":"message","left":"150px","top":"10px"});
//  chat_room.add(message);
    ...
    var message_store = new ajweb.data.store({ id: "message_store", tablename: "chat", url: "dbservlet",  properties: ["user_name", "message", "posted"], param: { op: "eq", property: "room_id", value: "1" }});
